$(document).ready(function () {
  ...
  if (window.localStorage.getItem("cookie-consent") == undefined) {
    $("body").append(
      "<div id='cookie-consent' class='cookie-consent'><span class='cookie-message'>By using our site you agree to our <a href='https://www.codepractice.io/cookies' class='cookie-link'>cookie policy</a>.</span><div class='cookie-button-cont'><svg width='16' height='16' class='cookie-button' id='cookie-accept' viewBox='0 0 122.88 122.88'><style xmlns='http://www.w3.org/2000/svg' type='text/css'>.st0{fill-rule:evenodd;clip-rule:evenodd;}</style>" +
